        ...
        <div className="max-w-5xl mx-auto">
          <div className="card-cartoon p-8 sm:p-12 text-center relative">
            ...
            <blockquote className="text-2xl sm:text-3xl font-medium mb-8 leading-relaxed">
              "Leadit transformó completamente nuestro proceso de ventas. Ahora generamos 3x más leads
              cualificados sin aumentar el equipo. La IA responde en segundos, 24/7."
            </blockquote>
